...
type WeatherServiceClient interface {
	GetWeather(ctx context.Context, in *GetRequest, opts ...grpc.CallOption) (*WeatherResponse, error)
}
...
func (c *weatherServiceClient) GetWeather(ctx context.Context, in *GetRequest, opts ...grpc.CallOption) (*WeatherResponse, error) {
...
type WeatherServiceServer interface {
	GetWeather(context.Context, *GetRequest) (*WeatherResponse, error)
...
func (UnimplementedWeatherServiceServer) GetWeather(context.Context, *GetRequest) (*WeatherResponse, error) {
...
func _WeatherService_GetWeather_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WeatherServiceServer).GetWeather(ctx, req.(*GetRequest))
	}
